...
We also can plot the energy term vs number of iteration plots shown in figure $\ref{fig:energy_vs_iterations}$. We observe that after 400 - 500 iterations we are within a error range of zero using the optimal value 
...
% find correct parameter setup is rather hard
