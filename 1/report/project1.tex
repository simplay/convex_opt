...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=0.32\linewidth]{figures/fruits_l1i1000Big}
\includegraphics[width=0.32\linewidth]{figures/fruits_l5i1000Big}
\includegraphics[width=0.32\linewidth]{figures/fruits_l10i1000Big}
~
\includegraphics[width=0.32\linewidth]{figures/fruits_l20i1000Big}
\includegraphics[width=0.32\linewidth]{figures/fruits_l50i1000Big}
\includegraphics[width=0.32\linewidth]{figures/fruits_l1950i1000Big}
~
\includegraphics[width=0.32\linewidth]{figures/fruits_l2000i1000Big}
\includegraphics[width=0.32\linewidth]{figures/fruits_l2020i1000Big}
\includegraphics[width=0.32\linewidth]{figures/fruits_l2400i1000Big}
\end{center}
\caption{Reconstructed demosaicing results when using different values for $\lambda$ when running 1000 iterations.}
\label{fig:different_lambda_values}
\end{figure}
